                        ...
                        <div class="panel-body">
                           <form method="POST" action="{{url('customer',$customer->id) }}">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder="Enter First Name" required="" value="{{$customer->name}}" name="name">
                              </div>
                              <div class="form-group">
                                 <label>Last Name</label>
                                 <input type="text" class="form-control" placeholder="Enter last Name" required="" name="lname" value="{{$customer->lname}}">
                              </div>
                              <div class="form-group">
                                 <label>Email</label>
                                 <input type="email" class="form-control" placeholder="Enter Email" required="" name="email" value="{{$customer->email}}">
                              </div>
                              <div class="form-group">
                                 <label>Mobile</label>
                                 <input type="number" class="form-control" placeholder="Enter Mobile" required="" name="mobile" value="{{$customer->mobile}}">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder="Enter Bank details" required="" value="{{$customer->bank_detail}}">
                              </div>
                              <div class="form-group">
                                 <label>Passport</label>
                                 <input type="text" class="form-control" placeholder="Enter Passport details" required="" value="{{$customer->passport}}">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input id="minMaxExample" type="text" class="form-control hasDatepicker" placeholder="Enter Date...">
                              </div>
                              <div class="form-group">
                                 <label>Address</label>
                                 <textarea class="form-control" rows="3" required="" value="{{$customer->address}}" name="address"></textarea>
                              </div>
                              <div class="form-group" >
                              ...
                              <div class="form-group">
                                 ...
                                 <label class="radio-inline"><input name="gender" value="{{$customer->gender}}" checked="checked" type="radio">Male</label> 
                                 <label class="radio-inline"><input name="gender" value="{{$customer->gender}}" type="radio">Female</label>
                              </div>
