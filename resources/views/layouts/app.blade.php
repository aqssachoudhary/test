...
<!-- Mirrored from thememinister.com/crm/clist.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Feb 2024 10:58:29 GMT -->
<head>
      <meta charset="utf-8">
         ...
         <aside class="main-sidebar">
            ...
            <div class="sidebar">
               ...
               <ul class="sidebar-menu">
                  <li class="active">
                     <a href="{{url('home')}}"><i class="fa fa-tachometer"></i><span>Dashboard</span>
                  ...
                  <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('customer/group')}}">Groups</a></li>
                     </ul>
                  </li>
                  <li class="treeview">
                     <a href="#">
...
<!-- Mirrored from thememinister.com/crm/clist.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Feb 2024 10:58:34 GMT -->
</html>